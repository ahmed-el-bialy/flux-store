...
part of 'categories_web_services.dart';
...
class _CategoriesWebServices implements CategoriesWebServices {
  _CategoriesWebServices(this._dio, {this.baseUrl, this.errorLogger}) {
